...
if __name__ == '__main__':
    ...
    if os.path.exists(file_path):
        ...
        if(model_type != "vo3b"):
            ...
            exit(0)
        model = Model_vo3b(*model_param).to(device)
