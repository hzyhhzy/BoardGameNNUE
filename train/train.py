...
if __name__ == '__main__':
    ...
    #data settings
    parser.add_argument('--tdatadir', type=str, default='../data/ataxx_value0_soft16_lastHalfData/', help='train dataset path: dir include dataset files or single dataset file')
    parser.add_argument('--vdatadir', type=str, default='', help='validation dataset path: dir include dataset files or single dataset file')
    ...
    #model parameters
    parser.add_argument('--modeltype', type=str, default='vo1',help='model type defined in model.py')
    parser.add_argument('--modelparam', nargs='+',type=int,
                        default=(32,16,6,512), help='model size')
    ...
    parser.add_argument('--weightdecay', type=float, default=-1, help='weight decay')
    ...
    vdata_files=[]
    if(args.vdatadir is not None and args.vdatadir!='' and os.path.exists(args.vdatadir)):
